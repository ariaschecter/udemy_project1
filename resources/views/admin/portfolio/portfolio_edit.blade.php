              ...
              <div class="card-body">
                ...
                <form method="post" action="{{ route('update.portfolio') }}" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input name="portfolio_name" class="form-control" type="text" value="{{ $portfolio->portfolio_name }}" id="portfolio_name">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input name="portfolio_title" class="form-control" type="text" value="{{ $portfolio->portfolio_title }}" id="portfolio_title">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <textarea name="portfolio_description" id="elm1" cols="30" rows="10">{{ $portfolio->portfolio_description }}</textarea>
