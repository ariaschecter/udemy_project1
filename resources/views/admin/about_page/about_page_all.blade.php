              ...
              <div class="card-body">
                ...
                <form method="post" action="{{ route('update.about') }}" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <textarea name="short_description" class="form-control" id="short_description" rows="10">{{ $aboutPage->short_description }}</textarea>
                        </div>
                    </div>
                    <!-- end row -->
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <textarea name="long_description" id="elm1" cols="30" rows="10">{{ $aboutPage->long_description }}</textarea>
                        </div>
                    </div>
                    <!-- end row -->
                  ...
                  <!-- end row -->
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-sm-10">
                          <img id="showImage" class="rounded avatar-lg" src="{{ (!empty($aboutPage->about_image)) ? url($aboutPage->about_image) : url('upload/no-image.jpg') }}" alt="Card image cap">
                      </div>
                  </div>
                  <!-- end row -->
